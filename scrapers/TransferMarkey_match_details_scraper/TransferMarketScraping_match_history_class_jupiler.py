        ...
        for year in list(range(begin_year, end_year+1)):
            ...
            for matchweek in list(range(40))[begin_matchweek:end_matchweek]:
                ...
                for one_match_url in list_matches_url:
                    ...
                    with open('Jupiler_pro_league_data.json', 'a') as f:
...
# scraping
scraper = TM_scrape(
    league_main_url='https://www.transfermarkt.com/jupiler-pro-league/spieltagtabelle/wettbewerb/BE1',
...
# Jupiler Pro League: 'https://www.transfermarkt.com/jupiler-pro-league/spieltagtabelle/wettbewerb/BE1'