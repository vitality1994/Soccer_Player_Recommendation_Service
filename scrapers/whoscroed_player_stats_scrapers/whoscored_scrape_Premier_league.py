...
#league urls
league_urls_num_matchweeks = {'//*[@id="popular-tournaments-list"]/li[1]/a': 38} 
...
for year_index in list(reversed(range(15)))[int(args.start_year)-2010:-1]: # change seasons
    ...
    for i in range(num_matchweeks)[num_matchweeks-starting_point:]:
        ...
        path = f'/Users/jooyong/github_locals/Soccer_Player_Recommendation_Service/data/player_stats(from_whoscored)/Premier_league_player_stats/'
        ...
        path = f'/Users/jooyong/github_locals/Soccer_Player_Recommendation_Service/data/player_stats(from_whoscored)/Premier_league_player_stats/{latest_year}-{latest_year+1}'
        file_list = os.listdir(path)
